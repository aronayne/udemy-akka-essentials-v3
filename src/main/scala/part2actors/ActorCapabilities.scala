...
object ActorCapabilities extends App{
  ...
  class SimpleActor extends Actor {
    ...
    override def receive: Receive = {
      // can also use instead: case "Hi!" => context.sender() ! "Hello, there" //replying to a message
      ...
      case WirelessPhoneMessage(content, ref) => ref forward (content + "s") // I keep the original sending of the wireless phone message
    }
  ...
  class BankAccount extends Actor {
    ...
    override def receive: Receive = {
      ...
      case Statement => sender () ! s"Your balace is $funds"
    }
  }
